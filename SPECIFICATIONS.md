...
## Attendance and Capacity Update
- Only a teacher assigned as class teacher can mark the register for that assigned Form/Grade.
- Class teachers mark absent students only; total absent students is shown.
- Other roles cannot edit the register.
- Demo includes five students each in Forms 1, 2 and 3.
- Principal and Deputy Principal can edit available Grade/Form spaces.
